...
fn test_reason() {
    assert_reason_results![
        ...
        ((2, 2), 0, (1, (5, 106))),
        //
        ((3, 2), 1, (12, (1_475, 3_140))),
        ((3, 2), 0, (6, (1_182, 13_128))),
        //
        ((2, 3), 1, (7, (2_117, 2_447))),
        ((2, 3), 0, (8, (1_438, 9_168))),
        //
        ((4, 2), 1, (45, (260_001, 467_142))),
        ((4, 2), 0, (35, (242_898, 2_291_637))),
        //
        ((2, 4), 1, (17, (306_445, 312_642))),
        ((2, 4), 0, (14, (387_536, 1_719_237))),
    ];
}
