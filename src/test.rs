...
fn test_reason() {
    assert_reason_results![
        ...
        ((2, 2), 0, (1, (4, 106))),
        //
        ((3, 2), 1, (12, (1_378, 3_140))),
        ((3, 2), 0, (12, (1_110, 13_128))),
        //
        ((2, 3), 1, (7, (2_125, 2_447))),
        ((2, 3), 0, (6, (1_433, 9_168))),
        //
        ((4, 2), 1, (45, (251_267, 467_142))),
        ((4, 2), 0, (35, (235_930, 2_291_637))),
        //
        ((2, 4), 1, (16, (307_349, 312_642))),
        ((2, 4), 0, (12, (387_018, 1_719_237))),
    ];
}
...
fn test_blank() {
    assert_blank_results![
        ...
        ((2, 3), (15, (10, 9_168))),
        //
        ((4, 2), (43, (561, 2_291_637))),
        //
        ((2, 4), (42, (6_456, 1_719_357))),
    ];
}
