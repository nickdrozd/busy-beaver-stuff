...
fn test_reason() {
    assert_reason_results![
        ...
        ((2, 2), 0, (1, (6, 106))),
        //
        ((3, 2), 1, (12, (1_632, 3_140))),
        ((3, 2), 0, (6, (1_287, 13_128))),
        //
        ((2, 3), 1, (5, (2_274, 2_447))),
        ((2, 3), 0, (1, (1_588, 9_168))),
        //
        ((4, 2), 1, (45, (272_857, 467_142))),
        ((4, 2), 0, (28, (261_337, 2_291_637))),
        //
        ((2, 4), 1, (16, (310_380, 312_642))),
        ((2, 4), 0, (2, (406_688, 1_719_237))),
    ];
}
...
fn test_reason_slow() {
    assert_reason_results![
        ((3, 3), 1, (53, (24_147_806, 25_306_222))),
        ((3, 3), 0, (124, (28_300_686, 149_365_898))),
        //
        ((5, 2), 1, (114, (57_361_209, 95_310_168))),
        ((5, 2), 0, (255, (64_386_064, 534_798_275))),
        //
        ((2, 5), 1, (28, (69_846_874, 70_028_531))),
...
fn test_blank() {
    assert_blank_results![
        ...
        ((2, 3), (6, (35, 9_168))),
        //
        ((4, 2), (43, (2_132, 2_291_637))),
        //
        ((2, 4), (33, (14_737, 1_719_357))),
    ];
}
