...
fn test_tree_slow() {
    assert_trees![
        ((3, 3), 1, (67_530, 25_306_290)),
        ((3, 3), 0, (480_338, 149_378_138)),
        //
        ((5, 2), 1, (99_640, 95_310_282)),
...
fn test_reason() {
    assert_reason_results![
        ...
        ((2, 2), 0, (1, (6, 106))),
        //
        ((3, 2), 1, (12, (1_514, 3_140))),
        ((3, 2), 0, (8, (1_268, 13_128))),
        //
        ((2, 3), 1, (10, (2_239, 2_447))),
        ((2, 3), 0, (4, (1_574, 9_168))),
        //
        ((4, 2), 1, (65, (259_952, 467_142))),
        ((4, 2), 0, (29, (255_016, 2_291_637))),
        //
        ((2, 4), 1, (20, (309_842, 312_642))),
        ((2, 4), 0, (9, (406_077, 1_719_237))),
    ];
}
...
fn test_reason_slow() {
    assert_reason_results![
        ((3, 3), 1, (58, (23_910_754, 25_306_222))),
        ((3, 3), 0, (124, (28_092_919, 149_365_898))),
        //
        ((5, 2), 1, (114, (55_434_555, 95_310_168))),
        ((5, 2), 0, (255, (62_650_015, 534_798_275))),
        //
        ((2, 5), 1, (34, (69_840_681, 70_028_531))),
        ((2, 5), 0, (77, (137_472_133, 515_051_756))),
    ];
}
