...
fn test_tree_slow() {
    assert_trees![
        ((3, 3), 1, (67_517, 25_306_290)),
        ((3, 3), 0, (480_326, 149_378_138)),
        //
        ((5, 2), 1, (99_638, 95_310_282)),
        // ((5, 2), 0, (477_315?, 534_813_722)),
        //
        ((2, 5), 1, (572_637, 70_032_629)),
...
fn test_reason() {
    assert_reason_results![
        ...
        ((2, 2), 0, (1, (6, 106))),
        //
        ((3, 2), 1, (12, (1_509, 3_140))),
        ((3, 2), 0, (8, (1_268, 13_128))),
        //
        ((2, 3), 1, (10, (2_226, 2_447))),
        ((2, 3), 0, (4, (1_574, 9_168))),
        //
        ((4, 2), 1, (65, (259_568, 467_142))),
        ((4, 2), 0, (29, (254_944, 2_291_637))),
        //
        ((2, 4), 1, (20, (309_812, 312_642))),
        ((2, 4), 0, (9, (406_076, 1_719_237))),
    ];
}
...
fn test_reason_slow() {
    assert_reason_results![
        ((3, 3), 1, (58, (23_895_091, 25_306_222))),
        ((3, 3), 0, (124, (28_091_445, 149_365_898))),
        //
        ((5, 2), 1, (114, (55_391_782, 95_310_168))),
        ((5, 2), 0, (255, (62_632_503, 534_798_275))),
        //
        ((2, 5), 1, (34, (69_840_556, 70_028_531))),
        ((2, 5), 0, (77, (137_472_131, 515_051_756))),
    ];
}
...
fn test_blank() {
    assert_blank_results![
        ...
        ((2, 3), (6, (35, 9_168))),
        //
        ((4, 2), (43, (2_125, 2_291_637))),
        //
        ((2, 4), (33, (14_734, 1_719_357))),
    ];
}
