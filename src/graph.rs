...
use crate::parse::{parse, show_state};
...
impl Graph {
    ...
    #[getter]
    pub fn exit_points(&self) -> ConGraph {
        self.arrows
            .iter()
    ...
    #[getter]
    pub fn entry_points(&self) -> ConGraph {
    ...
    pub fn is_normal(&self) -> bool {
        ...
        if states
            .iter()
            .skip(1)
            .any(|&state| !flat_graph.contains(show_state(Some(state))))
        {
            return false;
        }
        ...
        let positions: Vec<usize> = states
            .iter()
            .skip(1)
            .map(|&state| flat_graph.find(show_state(Some(state))).unwrap())
            .collect();
    ...
    #[getter]
    pub fn reflexive_states(&self) -> HashSet<State> {
        self.arrows
            .iter()
    ...
    #[getter]
    pub fn zero_reflexive_states(&self) -> HashSet<State> {
        self.arrows
            .iter()
    ...
    #[getter]
    pub fn is_zero_reflexive(&self) -> bool {
