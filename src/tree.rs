...
fn test_tree_slow() {
    assert_trees![
        ((4, 2), 1, (3_008, 467_142)),
        ((4, 2), 0, (6_886, 2_291_637)),
        //
        ((2, 4), 1, (20_366, 312_642)),
        ((2, 4), 0, (53_111, 1_719_237)),
        //
        ((5, 2), 1, (1_255_547, 95_310_168)),
        // ((5, 2), 0, (3_345_642?, 534_798_275)),
        //
        ((2, 5), 1, (7_066_741, 70_028_531)),
        // ((2, 5), 0, (31_264_702?, 515_051_756)),
        //
        ((3, 3), 1, (1_195_687, 25_306_222)),
        ((3, 3), 0, (2_763_422, 149_365_898)),
    ];
}
