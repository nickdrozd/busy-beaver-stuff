...
RECURRENCE = {
    ...
    "1RB 1RH 0RC 1LB 1LA 0RB": ('RECURR', 9, 19),   # total recurrence
    "1RB 1RH 1LB 0LC 1LA 1RA": ('RECURR', 12, 19),  # left barrier
    "1RB 1RH 1LC 1RA 1LA 0LC": ('RECURR', 12, 20),  # right barrier

    # quasihalting champs

    "1RB 1LB 1LB 1LA":         ('QSIHLT', 6, 7),    # 2-2

    "1RB 2LB 1LA 2LB 2RA 0RA": ('QSIHLT', 59, 60),  # 2-3 shift
    "1RB 2LB 1RA 2LB 2LA 0RA": ('QSIHLT', 43, 44),  # 2-3 sigma

    "1RB 1RC 1LC 1RA 1RA 1LA": ('QSIHLT', 9, 11),    # 3-2 sigma
    "1RB 0LB 1LA 0RC 1LC 1LA": ('QSIHLT', 55, 56),  # 3-2 shift
}
