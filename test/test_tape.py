...
class TestEnum(TestCase):
    ...
    def test_offsets_1(self):
        ...
        #  158 | B0 | 2 3^11 4 1^11 [0]
        #  159 | A1 | 2 3^11 4 1^10 [1]
        #  160 | A4 | 2 3^11 [4] 2^11
        #  161 | A3 | 2 3^10 [3] 2^12
        #  162 | B3 | 2 3^9 [3] 2^13
        #  163 | A2 | 2 3^9 4 [2] 2^12
        #  164 | A0 | 2 3^9 4 1^13 [0]
        #  165 | B0 | 2 3^9 4 1^14 [0]
    ...
    def test_offsets_2(self):
        ...
        #  928 | 2 | 3^6 2^414422564 [2] 5
        #  929 | 3 | 3^5 [3] 5^414422566
        #  930 | |5 | 3^5 2 [5] 5^414422565
