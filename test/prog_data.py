...
ALGEBRA: dict[str, dict[str, tuple[int, str, str, str]]] = {
    ...
    "count_apps: (2 ** ((-32 + (2 ** 37)) // 5)) % 100": {
        "1RB 2LA 5LB 0RA 1RA 3LB  1LA 4LA 3LB 3RB 3RB 1R_": (
            ...
            "((56002 + (((2 ** 35) * (57 + (95 * (2 ** ((-37 + (2 ** 37)) // 5))))) + ((2 ** ((158 + (2 ** 37)) // 5)) * (3 + (75 * (2 ** ((-165 + ((2 ** 37) * (-1 + (2 ** ((-32 + (2 ** 37)) // 5))))) // 5))))))) // 5)",
        ),
    },
    ...
    "count_apps: (2 ** ((-74 + (61 * (2 ** 105))) // 9)) % 4374": {
        "1RB 3LA 4LB 0RB 1RA 3LA  2LA 2RA 4LA 1RA 5RB 1R_": (
            ...
            "((96743685 + (((((((2 ** 97) * (15433 + (17629 * (2 ** ((-1001 + (61 * (2 ** 105))) // 9))))) + (3721 * (2 ** ((-109 + (61 * (2 ** ((-74 + (61 * (2 ** 105))) // 9)))) // 9)))) + (23485 * (2 ** ((-134 + (61 * (2 ** ((-55 + (61 * (2 ** ((-74 + (61 * (2 ** 105))) // 9)))) // 9)))) // 9)))) + (31049 * (2 ** ((-115 + (61 * (2 ** ((-80 + (61 * (2 ** ((-55 + (61 * (2 ** ((-74 + (61 * (2 ** 105))) // 9)))) // 9)))) // 9)))) // 9)))) + (126941 * (2 ** ((-100 + (61 * (2 ** ((-34 + (61 * (2 ** ((-80 + (61 * (2 ** ((-55 + (61 * (2 ** ((-74 + (61 * (2 ** 105))) // 9)))) // 9)))) // 9)))) // 9)))) // 9)))) + (5673 * (2 ** ((-125 + (61 * (2 ** ((-19 + (61 * (2 ** ((-34 + (61 * (2 ** ((-80 + (61 * (2 ** ((-55 + (61 * (2 ** ((-74 + (61 * (2 ** 105))) // 9)))) // 9)))) // 9)))) // 9)))) // 9)))) // 9))))) // 9)",
        ),
    },
