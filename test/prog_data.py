...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 1LA  1RC 0RE  1LD 0LA  1LC 0RD  1RC 1RB": (
        1299,
        "(54 + ((2 ** (26 + ((2 ** (~10^167)) + ((-320 + (5 * (2 ** (~10^167)))) // 12)))) + ((-160 + (5 * (2 ** (27 + ((2 ** (~10^167)) + ((-320 + (5 * (2 ** (~10^167)))) // 12)))))) // 3)))",
    ),
    "1RB 0LD  0RC 1LD  1LA 1RE  0LA 0LB  1RC 0RA": (
        4534,
        "(732422998 + (((-8748 + (4 * (3 ** 292968751))) // 8) + ((1093 * (3 ** 292968751)) + (((3 ** 292968751) * ((-8748 + (4 * (3 ** 58593751))) // 8)) + ((1093 * (3 ** 351562502)) + (((3 ** 351562502) * ((-8748 + (4 * (3 ** 11718751))) // 8)) + ((1093 * (3 ** 363281253)) + (((3 ** 363281253) * ((-8748 + (4 * (3 ** 2343751))) // 8)) + ((1093 * (3 ** 365625004)) + (((3 ** 365625004) * ((-8748 + (4 * (3 ** 468751))) // 8)) + ((1093 * (3 ** 366093755)) + (((3 ** 366093755) * ((-8748 + (4 * (3 ** 93751))) // 8)) + ((1093 * (3 ** 366187506)) + (((3 ** 366187506) * ((-8748 + (4 * (3 ** 18751))) // 8)) + ((1093 * (3 ** 366206257)) + (((~10^449) * (3 ** 366210008)) + ((3 ** 366206257) * ((-8748 + (4 * (3 ** 3751))) // 8))))))))))))))))))",
    ),
