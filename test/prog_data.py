...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 0LA  1LC 1LF  0LD 0LC  0LE 0LB  1RE 0RA  1R_ 1LD": (
        3344,
        "(208787669 + ((4480 * ((-64 + (8 ** (4388 + ((12992 * (((-64 + (8 ** 23048)) // 63) // 189)) + (23612377 * (8 ** 23050)))))) // 63)) + (52195782 * (8 ** (4390 + ((12992 * (((-64 + (8 ** 23048)) // 63) // 189)) + (23612377 * (8 ** 23050))))))))",
    ),
    ...
    "1RB 1LE  1RC 1RF  1LD 0RB  1RE 0LC  1LA 0RD  1R_ 1RC": (
        5723,
        "(2126281 + ((2125760 * ((-4096 + (8 ** 20208)) // 4095)) + ((~10^15) * (8 ** 20210))))",
    ),
    "1RB 0LD  1RC 0RF  1LC 1LA  0LE 1R_  1LA 0RB  0RC 0RE": (
        413,
        "(107 + ((3 ** 22145) + (63 * ((-3 + (3 ** 22143)) // 2))))",
    ),
    ...
    "1RB 2LB 4RB 1LA 1RB 1R_  1LA 3RA 5RA 4LB 0RA 4LA": (
        937,
        "(111 + ((80 * ((-4 + (2 ** 2716)) // 3)) + (681 * (2 ** 2720))))",
    ),
    "1RB 1RA 2LB 3LA  2LA 0LB 1LC 1LB  3RB 3RC 1R_ 1LC": (
        347,
        "(26 + ((19 * ((-3 + (3 ** 13656)) // 2)) + (1003 * (3 ** 13656))))",
    ),
    "1RB 1LA 3LA 3RC  2LC 2LB 1RB 1RA  2LA 3LC 1R_ 1LB": (
        227,
        "(16 + ((13 * ((-4 + (2 ** 4312)) // 3)) + (1617 * (2 ** 4312))))",
    ),
    "1RB 3LA 3RC 1RA  2RC 1LA 1R_ 2RB  1LC 1RB 1LB 2RA": (
        681,
        "(~10^628)",
    ...
    "1RB 0RD  0LC 1RE  1RA 1LD  0LC 1LC  0RD 0LE": (
        711,
        "(-3 + ((2 ** ((2 ** (-1 + ((2 ** (-1 + (3 * (2 ** 6143)))) + (2 ** (3 * (2 ** 6143)))))) + (2 ** ((2 ** (-1 + (3 * (2 ** 6143)))) + (2 ** (3 * (2 ** 6143))))))) + (2 ** (1 + ((2 ** (-1 + ((2 ** (-1 + (3 * (2 ** 6143)))) + (2 ** (3 * (2 ** 6143)))))) + (2 ** ((2 ** (-1 + (3 * (2 ** 6143)))) + (2 ** (3 * (2 ** 6143))))))))))",
    ),
    ...
    "1RB 1RE  1LC 1LF  1RD 0LB  1LE 0RC  1RA 0LD  1R_ 1LC": (
        10217,
        "((~10^15) + ((531440 * ((-4096 + (8 ** (15120204 + ((4 * ((34012160 * ((-4096 + (8 ** 5036)) // 4095)) // 9)) + ((~10^15) * (8 ** 5040)))))) // 4095)) + (158 * (8 ** (15120205 + ((4 * ((34012160 * ((-4096 + (8 ** 5036)) // 4095)) // 9)) + ((~10^15) * (8 ** 5040))))))))",
    ),
    ...
    "1RB 0LD  0RC 0RA  1LD 1LE  1RE 1LC  0LE 1LA": (
        2447,
        "(23540 + ((2 ** 11760) + ((-16 * (2 ** 11757)) + ((2 ** 17639) + ((4 * ((2 ** 11757) * (-16 * (2 ** 5877)))) + ((2 ** 20578) + ((4 * ((2 ** 11757) * (4 * ((2 ** 5877) * (-16 * (2 ** 2937)))))) + ((2 ** 22047) + (4 * ((2 ** 11757) * (4 * ((2 ** 5877) * (4 * ((2 ** 2937) * ((~10^441) * (2 ** 1467))))))))))))))))",
    ),
    "1RB 1RA  1LC 0RB  1LB 1LD  0RA 0RE  0RB 1RE": (
        389,
        "(-1 + ((2 ** (-3 + ((2 ** (-2 + ((2 ** (-2 + (3 * (2 ** (~10^14))))) + (2 ** (-1 + (3 * (2 ** (~10^14)))))))) + (2 ** (-1 + ((2 ** (-2 + (3 * (2 ** (~10^14))))) + (2 ** (-1 + (3 * (2 ** (~10^14))))))))))) + (2 ** (-2 + ((2 ** (-2 + ((2 ** (-2 + (3 * (2 ** (~10^14))))) + (2 ** (-1 + (3 * (2 ** (~10^14)))))))) + (2 ** (-1 + ((2 ** (-2 + (3 * (2 ** (~10^14))))) + (2 ** (-1 + (3 * (2 ** (~10^14)))))))))))))",
    ),
    ...
    "1RB 3LA 4LB 0RB 1RA 3LA  2LA 2RA 4LA 1RA 5RB 1R_": (
        5524,
        "(1524 + ((1360 * ((-16 + (2 ** (4 * ((1354 + ((1280 * ((-16 + (2 ** (~10^32))) // 15)) + (83285 * (2 ** (~10^32))))) // 3)))) // 15)) + (157 * (2 ** (4 + (4 * ((1354 + ((1280 * ((-16 + (2 ** (~10^32))) // 15)) + (83285 * (2 ** (~10^32))))) // 3)))))))",
    ),
    "1RB 1LE  1RC 1RE  1RD 1RB  0LB 0LD  1LA 0LA": (
        1080,
        "(-2 + ((2 ** (-2 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17)))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17))))))))))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17)))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17)))))))))))))))))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17)))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17))))))))))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17)))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17))))))))))))))))))))))))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17)))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17))))))))))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17)))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17)))))))))))))))))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17)))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17))))))))))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + ((2 ** (-2 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17)))))))) + (5 * (2 ** (-3 + (7 * (2 ** (-3 + (7 * (2 ** (~10^17))))))))))))))))))))))))))))))))",
    ),
