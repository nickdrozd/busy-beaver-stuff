...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 1RA 2LB 3LA  2LA 0LB 1LC 1LB  3RB 3RC 1R_ 1LC": (
        347,
        "((7 + (1003 * (3 ** 13656))) + (19 + (19 * ((-3 + (3 ** 13656)) // 2))))",
    ),
    "1RB 1LA 3LA 3RC  2LC 2LB 1RB 1RA  2LA 3LC 1R_ 1LB": (
        227,
        "((3 + (1617 * (4 ** 2156))) + (13 + (13 * ((-4 + (4 ** 2156)) // 3))))",
    ),
    "1RB 3LA 3RC 1RA  2RC 1LA 1R_ 2RB  1LC 1RB 1LB 2RA": (
        681,
        "(~10^628)",
    ...
    "1RB 2RB 3RB 4RB 5LA 4RA  0LA 1RB 5RA ... ... 1LB": (
        957,
        "((2 * (2 ** ((-3 + (4 * (2 ** ((-3 + (4 * (2 ** ((-3 + (4 * (2 ** 65533))) + (4 * (2 ** 65533)))))) + (4 * (2 ** ((-3 + (4 * (2 ** 65533))) + (4 * (2 ** 65533))))))))) + (4 * (2 ** ((-3 + (4 * (2 ** ((-3 + (4 * (2 ** 65533))) + (4 * (2 ** 65533)))))) + (4 * (2 ** ((-3 + (4 * (2 ** 65533))) + (4 * (2 ** 65533))))))))))) + (2 * (2 ** ((-3 + (4 * (2 ** ((-3 + (4 * (2 ** ((-3 + (4 * (2 ** 65533))) + (4 * (2 ** 65533)))))) + (4 * (2 ** ((-3 + (4 * (2 ** 65533))) + (4 * (2 ** 65533))))))))) + (4 * (2 ** ((-3 + (4 * (2 ** ((-3 + (4 * (2 ** 65533))) + (4 * (2 ** 65533)))))) + (4 * (2 ** ((-3 + (4 * (2 ** 65533))) + (4 * (2 ** 65533))))))))))))",
    ),
    "1RB 2LA 3LA 2LA  3LB 3RA 0RA 0RB": (
        9652,
        "((~10^63) + ((2 ** (~10^63)) * (2 + ((2 ** (~10^63)) * (2 + ((2 ** (~10^63)) * (2 + ((2 ** (~10^63)) * (2 + (32 * (2 ** (~10^63))))))))))))",
    ),
    "1RB 2LA 0RB 0LA  3LB 2LA 1RA 3RA": (
        9210,
        "((~10^136) + ((2 ** (~10^136)) * (4 + ((2 ** (~10^136)) * (4 + ((2 ** (~10^136)) * (4 + ((2 ** (~10^136)) * (4 + (64 * (2 ** (~10^136))))))))))))",
    ),
    "1RB 2LA 1RA 2RB  2LB 1LA 3RB 1LB": (
        1480,
        "((2 + (6 * (2 ** (-1 + (((-22 + (48 * (2 ** (-1 + (((-22 + (48 * (2 ** (-1 + (((-22 + (48 * (2 ** (~10^36)))) + (16 * (2 ** (~10^36)))) // 2))))) + (16 * (2 ** (-1 + (((-22 + (48 * (2 ** (~10^36)))) + (16 * (2 ** (~10^36)))) // 2))))) // 2))))) + (16 * (2 ** (-1 + (((-22 + (48 * (2 ** (-1 + (((-22 + (48 * (2 ** (~10^36)))) + (16 * (2 ** (~10^36)))) // 2))))) + (16 * (2 ** (-1 + (((-22 + (48 * (2 ** (~10^36)))) + (16 * (2 ** (~10^36)))) // 2))))) // 2))))) // 2))))) + (2 * (2 ** (-1 + (((-22 + (48 * (2 ** (-1 + (((-22 + (48 * (2 ** (-1 + (((-22 + (48 * (2 ** (~10^36)))) + (16 * (2 ** (~10^36)))) // 2))))) + (16 * (2 ** (-1 + (((-22 + (48 * (2 ** (~10^36)))) + (16 * (2 ** (~10^36)))) // 2))))) // 2))))) + (16 * (2 ** (-1 + (((-22 + (48 * (2 ** (-1 + (((-22 + (48 * (2 ** (~10^36)))) + (16 * (2 ** (~10^36)))) // 2))))) + (16 * (2 ** (-1 + (((-22 + (48 * (2 ** (~10^36)))) + (16 * (2 ** (~10^36)))) // 2))))) // 2))))) // 2)))))",
    ),
    "1RB 1RE  1LC 1LF  1RD 0LB  1LE 0RC  1RA 0LD  1R_ 1LC": (
        6439,
        "((34020545 + (34012160 * ((-4096 + (4096 ** 1259)) // 4095))) + ((~10^19) * (4096 ** 1259)))",
    ),
}
