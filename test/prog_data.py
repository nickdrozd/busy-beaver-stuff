...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 1RA  1LC 0RB  1LB 1LD  0RA 0RE  0RB 1RE": (
        389,
        "(-1 + ((2 ** (-3 + ((2 ** (-2 + ((2 ** (-2 + ((2 ** (~10^14)) + (2 ** (~10^14))))) + (2 ** (-1 + ((2 ** (~10^14)) + (2 ** (~10^14)))))))) + (2 ** (-1 + ((2 ** (-2 + ((2 ** (~10^14)) + (2 ** (~10^14))))) + (2 ** (-1 + ((2 ** (~10^14)) + (2 ** (~10^14))))))))))) + (2 ** (-2 + ((2 ** (-2 + ((2 ** (-2 + ((2 ** (~10^14)) + (2 ** (~10^14))))) + (2 ** (-1 + ((2 ** (~10^14)) + (2 ** (~10^14)))))))) + (2 ** (-1 + ((2 ** (-2 + ((2 ** (~10^14)) + (2 ** (~10^14))))) + (2 ** (-1 + ((2 ** (~10^14)) + (2 ** (~10^14)))))))))))))",
    ),
}
