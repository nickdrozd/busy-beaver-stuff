...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 2LA 3LA 2LA  3LB 3RA 0RA 0RB": (
        9652,
        "(((~10^63) + ((2 ** (~10^63)) * ((2 + ((2 ** (~10^63)) * ((2 + ((2 ** (~10^63)) * ((2 + ((2 ** (~10^63)) * ((2 + (32 * (2 ** (~10^63)))) + (0 + (0 * (2 ** (~10^63))))))) + (0 + (0 * (2 ** (~10^63))))))) + (0 + (0 * (2 ** (~10^63))))))) + (0 + (0 * (2 ** (~10^63))))))) + (0 + (0 * (2 ** (~10^63)))))",
    ),
    "1RB 2LA 0RB 0LA  3LB 2LA 1RA 3RA": (
        9210,
        "(((~10^136) + ((2 ** (~10^136)) * ((4 + ((2 ** (~10^136)) * ((4 + ((2 ** (~10^136)) * ((4 + ((2 ** (~10^136)) * ((4 + (64 * (2 ** (~10^136)))) + (0 + (0 * (2 ** (~10^136))))))) + (0 + (0 * (2 ** (~10^136))))))) + (0 + (0 * (2 ** (~10^136))))))) + (0 + (0 * (2 ** (~10^136))))))) + (0 + (0 * (2 ** (~10^136)))))",
    ),
}
