...
ALGEBRA: dict[str, dict[str, tuple[int, str, str, str]]] = {
    "spinout": {
        ...
        "1RB 0LB 2LA  1LA 0RC 0LB  2RC 2RB 0LC": (
            ...
            "(936 + ((2 ** 19) * (3 + ((2 ** (-16 + (2 ** (4 + (2 ** (4 + (2 ** (4 + (2 ** (4 + (2 ** 20))))))))))) + ((2 ** (-15 + (2 ** (4 + (2 ** (4 + (2 ** (4 + (2 ** 20))))))))) + ((2 ** (-16 + (2 ** (4 + (2 ** (4 + (2 ** (4 + (2 ** 20))))))))) + ((2 ** (-15 + (2 ** (4 + (2 ** (4 + (2 ** 20))))))) + ((2 ** (-16 + (2 ** (4 + (2 ** (4 + (2 ** 20))))))) + ((2 ** (-15 + (2 ** (4 + (2 ** 20))))) + ((2 ** (-16 + (2 ** 20))) * (3 + (2 ** ((2 ** 20) * (-1 + (2 ** (-16 + (2 ** 20)))))))))))))))))",
        ),
        # "1RB ...  1RC 0RF  1RD 0LF  1LE 0RC  1LD 0RE  1LC 1RA": (
        #     711,
        #     "1",
    ...
    "halt": {
        ...
        "1RB ...  1RC 1RA  1RD 0RB  1LE 0RC  0LF 0LD  0LB 1LA": (
            ...
            "(10 ** 98642)",
            "(-4 + (5 * (2 ** (-3 + (5 * (2 ** 16))))))",
            "(19724 + ((5 * (2 ** (-3 + (5 * (2 ** 16))))) + ((2 ** 16) * (55 + (5 * (2 ** (-19 + (5 * (2 ** 16)))))))))",
        ),
        "1RB 1RA 2LB 3LA  2LA 0LB 1LC 1LB  3RB 3RC ... 1LC": (
            403,
            "(10 ** 6518)",
        ...
        "1RB 1LA ... ...  1RC 3LB 1RB 0LC  2LA 2LC ... 3LC": (
            ...
            "(10 ** 443682)",
            "((-17 + (13 * (5 ** 634766))) // 4)",
            "((1905209 + (39 * (5 ** 634764))) // 2)",
        ),
        "1RB 0LB ... 3LA  0LC 3RB 3RC 1LB  2RB 2LA 3RA 1LC": (
            998,
            "(10 ↑↑ 2049)",
            "(4 + (2 ** ...))",
            "(4513 + ((2 ** 17) * (5 + ((2 ** (-17 + (2 ** (2 + (2 ** (2 + (2 ** (2 + (2 ** 19))))))))) + ((2 ** (-15 + (2 ** (2 + (2 ** (2 + (2 ** 19))))))) + ((2 ** (-17 + (2 ** (2 + (2 ** (2 + (2 ** 19))))))) + ((2 ** (-15 + (2 ** (2 + (2 ** 19))))) + ((2 ** (-17 + (2 ** 19))) * (5 + (2 ** ((2 ** 19) * (-1 + (2 ** (-17 + (2 ** 19)))))))))))))))",
        ),
        ...
        "1RB 0LA  1LC 1LF  0LD 0LC  0LE 0LB  1RE 0RA  ... 1LD": (
            1661,
            "(10 ↑↑ 5)",
            "((40 + (19 * (2 ** ((-17 + (7 * (2 ** ((-11 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9)))) // 9)))) // 9)",
            "((1856045 + ((19 * (2 ** ((-26 + (7 * (2 ** ((-11 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9)))) // 9))) + (((7 * (2 ** ((-11 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))) + (((7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9))) + ((21 * (2 ** ((-38 + (19 * (2 ** 69175))) // 9))) + ((2 ** 69173) * (133 + (21 * (2 ** ((-622595 + (19 * (2 ** 69175))) // 9))))))) + (21 * (2 ** ((-29 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))))) + (57 * (2 ** ((-35 + (7 * (2 ** ((-11 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9)))) // 9)))))) // 9)",
        ),
        ...
        "1RB 1RE  1LC 1LF  1RD 0LB  1LE 0RC  1RA 0LD  ... 1LC": (
            16859,
            "(10 ↑↑ 5)",
            "((74 + (49 * (2 ** ((-70 + (49 * (2 ** ((-34 + (49 * (2 ** ((62 + (49 * (2 ** 15172))) // 27)))) // 27)))) // 27)))) // 9)",
            "(... // 27)",
        ),
        # "1RB 1RC  0RD 0RB  ... 1RA  1RE 1LF  0RG 0RE  0RC 1RB  1RH 1LD  0RI 0RH  1LI 1LG": (
        #     1793,
        ...
        "1RB 1RD 1LC  2LB 1RB 1LC  ... 1LA 1LD  2RB 2RA 2RD": (
            4298,
            "(10 ↑↑ 10)",
            "(2 + (3 * (2 ** (2 + (3 * (2 ** (1 + (3 * (2 ** (1 + (3 * (2 ** (1 + (3 * (2 ** (1 + (3 * (2 ** (1 + (3 * (2 ** (1 + (3 * (2 ** (1 + (3 * (2 ** 25)))))))))))))))))))))))))))",
            "(5432 + (... + ...))",
        ),
        ...
        "1LB ...  0LC 1LC  0LD 0LC  1LE 1RA  0LF 0LE  1LG 1RD  0LH 0LG  1LI 1RF  0LJ 0LI  1RJ 1RH": (
            ...
            "!!!",
            "((-1 + (7 * (3 ** (8 + !!!)))) // 2)",
            "((22712 + ((7 * (3 ** (7 + !!!))) + ((2 * !!!) + ((7 * (3 ** ((-1 + (7 * (3 ** 31))) // 2))) + (((7 * (3 ** ((-1 + (7 * (3 ** ((-1 + (7 * (3 ** ((-1 + (7 * (3 ** 31))) // 2)))) // 2)))) // 2))) + (((7 * (3 ** ((-1 + (7 * (3 ** ((-1 + (7 * (3 ** 31))) // 2)))) // 2))) + ((7 * (3 ** ((-3 + (7 * (3 ** ((-1 + (7 * (3 ** 31))) // 2)))) // 2))) + ((7 * (3 ** ((-1 + (7 * (3 ** 31))) // 2))) + ((7 * (3 ** ((-3 + (7 * (3 ** 31))) // 2))) + ((7 * (3 ** 31)) + ((3 ** 30) * (35 + (7 * (3 ** ((-63 + (7 * (3 ** 31))) // 2)))))))))) + (7 * (3 ** ((-3 + (7 * (3 ** ((-1 + (7 * (3 ** ((-1 + (7 * (3 ** 31))) // 2)))) // 2)))) // 2))))) + (7 * (3 ** ((-3 + (7 * (3 ** ((-1 + (7 * (3 ** ((-1 + (7 * (3 ** ((-1 + (7 * (3 ** 31))) // 2)))) // 2)))) // 2)))) // 2)))))))) // 2)",
        ),
    },
    ...
    "infrul": {
        "1RB 1RB 1LA  2LC 0LB 2LB  2RC 2RA 0LC": (
            ...
            "(10 ↑↑ 5)",
            "(-5 + (3 * (2 ** (2 ** (2 ** (2 ** 16))))))",
            "(732 + ((2 ** 16) * (1 + ((2 ** (-16 + (2 ** 16))) * (1 + (2 ** ((2 ** 16) * (-1 + (2 ** (-16 + (2 ** 16)))))))))))",
        ),
        "1RB 1LA ...  1RC 2LB 1RB  2LA 2LC 0LC": (
            465,
            "(10 ↑↑ 6)",
            "((-15 + (3 ** ((3 + (3 ** ((3 + (3 ** ((3 + (3 ** ((3 + (3 ** 1642)) // 4))) // 4))) // 4))) // 4))) // 2)",
            "((14898 + (((3 ** ((3 + (3 ** ((3 + (3 ** ((3 + (3 ** 1642)) // 4))) // 4))) // 4)) + (((3 ** ((3 + (3 ** ((3 + (3 ** 1642)) // 4))) // 4)) + (((3 ** 1641) * (5 + (5 * (3 ** ((-6565 + (3 ** 1642)) // 4))))) + (2 * (3 ** ((-1 + (3 ** ((3 + (3 ** 1642)) // 4))) // 4))))) + (2 * (3 ** ((-1 + (3 ** ((3 + (3 ** ((3 + (3 ** 1642)) // 4))) // 4))) // 4))))) + (2 * (3 ** ((-1 + (3 ** ((3 + (3 ** ((3 + (3 ** ((3 + (3 ** 1642)) // 4))) // 4))) // 4))) // 4))))) // 4)",
        ),
        "1RB 0RD  0RC 0RB  1LC 0LA  0RA 1RE  0LB 1RB": (
            399,
            "3",
            "3",
            "(2227 + ((3 ** (3 ** (3 ** (3 ** 27)))) + ((2 * (3 ** (3 ** (3 ** (3 ** 27))))) + ((3 ** (3 ** (3 ** 27))) + ((2 * (3 ** (3 ** (3 ** 27)))) + ((3 ** 28) * (1 + (3 ** (-27 + (3 ** 27))))))))))",
        ),
        "1RB 1RA  1LC 0RB  1LB 1LD  0RA 0RE  0RB 1RE": (
            467,
            "(10 ↑↑ 6)",
            "(-8 + (3 * (2 ** (-1 + (3 * (2 ** (-2 + (3 * (2 ** (-2 + (3 * (2 ** (-2 + (3 * (2 ** 46)))))))))))))))",
            "(556 + ((((3 * (2 ** (-2 + (3 * (2 ** 46))))) + ((2 ** 47) * (3 + (3 * (2 ** (-49 + (3 * (2 ** 46)))))))) + (3 * (2 ** (-1 + (3 * (2 ** (-2 + (3 * (2 ** 46))))))))) + (3 * (2 ** (-1 + (3 * (2 ** (-2 + (3 * (2 ** (-2 + (3 * (2 ** 46)))))))))))))",
        ),
    },
