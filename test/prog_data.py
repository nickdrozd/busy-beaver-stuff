...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 0LA  1LC 1LF  0LD 0LC  0LE 0LB  1RE 0RA  1R_ 1LD": (
        3344,
        "(208787669 + ((52195782 * (8 ** (4390 + ((23612377 * (8 ** 23050)) + ((-118784 + (29 * (8 ** 23050))) // 27))))) + ((-40960 + (10 * (8 ** (4390 + ((23612377 * (8 ** 23050)) + ((-118784 + (29 * (8 ** 23050))) // 27)))))) // 9)))",
    ),
    ...
    "1RB 1LE  1RC 1RF  1LD 0RB  1RE 0LC  1LA 0RD  1R_ 1RC": (
        5723,
        "(2126281 + (((~10^15) * (8 ** 20210)) + ((-19136512 + (73 * (8 ** 20210))) // 9)))",
    ),
    ...
    "1RB 1RE  1LC 1LF  1RD 0LB  1LE 0RC  1RA 0LD  1R_ 1LC": (
        10105,
        "((~10^15) + ((316 * (8 ** (2 + ((136081828 + (((~10^16) * (8 ** 5040)) + ((-1224736768 + (73 * (8 ** 5040))) // 9))) // 9)))) + ((-76546048 + (292 * (8 ** (2 + ((136081828 + (((~10^16) * (8 ** 5040)) + ((-1224736768 + (73 * (8 ** 5040))) // 9))) // 9))))) // 9)))",
    ),
