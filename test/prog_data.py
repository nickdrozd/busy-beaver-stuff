...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 1RE  1LC 1LF  1RD 0LB  1LE 0RC  1RA 0LD  1R_ 1LC": (
        10105,
        "((~10^15) + ((8503040 * ((-4096 + (8 ** (4 * ((34020457 + ((34012160 * ((-4096 + (8 ** 5036)) // 4095)) + ((~10^17) * (8 ** 5039)))) // 9)))) // 4095)) + (316 * (8 ** (2 + (4 * ((34020457 + ((34012160 * ((-4096 + (8 ** 5036)) // 4095)) + ((~10^17) * (8 ** 5039)))) // 9)))))))",
    ),
    ...
    "1RB 0LD  0RC 0RA  1LD 1LE  1RE 1LC  0LE 1LA": (
        2447,
        "(23540 + ((2 ** 11760) + ((-16 * (2 ** 11757)) + ((2 ** 17639) + ((-64 * (2 ** 17634)) + ((2 ** 20578) + ((-256 * (2 ** 20571)) + ((2 ** 22047) + ((~10^443) * (2 ** 22038))))))))))",
    ),
