...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 1LE  1RC 1RF  1LD 0RB  1RE 0LC  1LA 0RD  1R_ 1RC": (
        5723,
        "((2126281 + ((~10^17) * (4096 ** 5052))) + (2125760 * ((-4096 + (4096 ** 5052)) // 4095)))",
    ),
    ...
    "1RB 2LB 4RB 1LA 1RB 1R_  1LA 3RA 5RA 4LB 0RA 4LA": (
        937,
        "((111 + (10896 * (4 ** 1358))) + (80 * ((-4 + (4 ** 1358)) // 3)))",
    ),
    "1RB 1RA 2LB 3LA  2LA 0LB 1LC 1LB  3RB 3RC 1R_ 1LC": (
        347,
    ...
    "1RB 2LA 1RA 2RB  2LB 1LA 3RB 1LB": (
        1480,
        "((2 + (2 * (2 ** (-1 + (((-22 + (16 * (2 ** (-1 + (((-22 + (16 * (2 ** (-1 + (((-22 + (16 * (2 ** (~10^36)))) + (48 * (2 ** (~10^36)))) // 2))))) + (48 * (2 ** (-1 + (((-22 + (16 * (2 ** (~10^36)))) + (48 * (2 ** (~10^36)))) // 2))))) // 2))))) + (48 * (2 ** (-1 + (((-22 + (16 * (2 ** (-1 + (((-22 + (16 * (2 ** (~10^36)))) + (48 * (2 ** (~10^36)))) // 2))))) + (48 * (2 ** (-1 + (((-22 + (16 * (2 ** (~10^36)))) + (48 * (2 ** (~10^36)))) // 2))))) // 2))))) // 2))))) + (6 * (2 ** (-1 + (((-22 + (16 * (2 ** (-1 + (((-22 + (16 * (2 ** (-1 + (((-22 + (16 * (2 ** (~10^36)))) + (48 * (2 ** (~10^36)))) // 2))))) + (48 * (2 ** (-1 + (((-22 + (16 * (2 ** (~10^36)))) + (48 * (2 ** (~10^36)))) // 2))))) // 2))))) + (48 * (2 ** (-1 + (((-22 + (16 * (2 ** (-1 + (((-22 + (16 * (2 ** (~10^36)))) + (48 * (2 ** (~10^36)))) // 2))))) + (48 * (2 ** (-1 + (((-22 + (16 * (2 ** (~10^36)))) + (48 * (2 ** (~10^36)))) // 2))))) // 2))))) // 2)))))",
    ),
    "1RB 1RE  1LC 1LF  1RD 0LB  1LE 0RC  1RA 0LD  1R_ 1LC": (
        6439,
        "((34020545 + ((~10^19) * (4096 ** 1259))) + (34012160 * ((-4096 + (4096 ** 1259)) // 4095)))",
    ),
}
