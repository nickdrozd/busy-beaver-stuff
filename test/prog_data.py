...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 3LA 4LB 0RB 1RA 3LA  2LA 2RA 4LA 1RA 5RB 1R_": (
        5524,
        "(78 + ((-14 + (61 * (2 ** (1 + ((-82 + (61 * (2 ** (~10^32)))) // 9))))) // 3))",
    ),
    ...
    "1RB 1LA  1RC 0RE  1LD 0LA  1LC 0RD  1RC 1RB": (
        1299,
        "(2 + ((-4 + ((3 * (2 ** ((-2 + (13 * (2 ** (~10^167)))) // 3))) + (5 * (2 ** (1 + (((-2 + (13 * (2 ** (~10^167)))) // 3) + (((-2 + (13 * (2 ** (~10^167)))) // 3) + -((-2 + (13 * (2 ** (~10^167)))) // 3)))))))) // 3))",
    ),
    "1RB 0LD  0RC 1LD  1LA 1RE  0LA 0LB  1RC 0RA": (
        3598,
        "(5859398 + ((3 + ((3 ** 2343751) + ((2 * (3 ** 2343751)) * (-1 + ((1 + ((3 ** 468751) + ((2 * (3 ** 468751)) * (-1 + ((1 + ((3 ** 93751) + ((2 * (3 ** 93751)) * (-1 + ((1 + ((3 ** 18751) + ((2 * (3 ** 18751)) * (-1 + ((1 + (3 ** 4693)) // 2))))) // 2))))) // 2))))) // 2))))) // 2))",
    ),
