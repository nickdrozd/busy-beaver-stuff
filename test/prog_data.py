...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 0LA  1LC 1LF  0LD 0LC  0LE 0LB  1RE 0RA  1R_ 1LD": (
        3344,
        "(208787669 + ((52195782 * (8 ** (4390 + ((23612377 * (8 ** 23050)) + (12992 * (((-64 + (8 ** 23048)) // 63) // 189)))))) + (4480 * ((-64 + (8 ** (4388 + ((23612377 * (8 ** 23050)) + (12992 * (((-64 + (8 ** 23048)) // 63) // 189)))))) // 63))))",
    ),
    ...
    "1RB 1RA 2LB 3LA  2LA 0LB 1LC 1LB  3RB 3RC 1R_ 1LC": (
        347,
        "(26 + ((1003 * (3 ** 13656)) + (19 * ((-3 + (3 ** 13656)) // 2))))",
    ),
    "1RB 1LA 3LA 3RC  2LC 2LB 1RB 1RA  2LA 3LC 1R_ 1LB": (
        227,
        "(16 + ((1617 * (2 ** 4312)) + (13 * ((-4 + (2 ** 4312)) // 3))))",
    ),
    "1RB 3LA 3RC 1RA  2RC 1LA 1R_ 2RB  1LC 1RB 1LB 2RA": (
        681,
        "(~10^628)",
    ...
    "1RB 0RD  0LC 1RE  1RA 1LD  0LC 1LC  0RD 0LE": (
        711,
        "(-3 + ((2 ** ((2 ** ((2 ** (3 * (2 ** 6143))) + (2 ** (-1 + (3 * (2 ** 6143)))))) + (2 ** (-1 + ((2 ** (3 * (2 ** 6143))) + (2 ** (-1 + (3 * (2 ** 6143))))))))) + (2 ** (1 + ((2 ** ((2 ** (3 * (2 ** 6143))) + (2 ** (-1 + (3 * (2 ** 6143)))))) + (2 ** (-1 + ((2 ** (3 * (2 ** 6143))) + (2 ** (-1 + (3 * (2 ** 6143))))))))))))",
    ),
    ...
    "1RB 1RE  1LC 1LF  1RD 0LB  1LE 0RC  1RA 0LD  1R_ 1LC": (
        10105,
        "((~10^15) + ((316 * (8 ** (2 + (4 * ((34020457 + (((~10^17) * (8 ** 5039)) + (34012160 * ((-4096 + (8 ** 5036)) // 4095)))) // 9))))) + (8503040 * ((-4096 + (8 ** (4 * ((34020457 + (((~10^17) * (8 ** 5039)) + (34012160 * ((-4096 + (8 ** 5036)) // 4095)))) // 9)))) // 4095))))",
    ),
    ...
    "1RB 3LA 4LB 0RB 1RA 3LA  2LA 2RA 4LA 1RA 5RB 1R_": (
        5524,
        "(1524 + ((157 * (2 ** (4 + (4 * ((1354 + ((83285 * (2 ** (~10^32))) + (1280 * ((-16 + (2 ** (~10^32))) // 15)))) // 3))))) + (1360 * ((-16 + (2 ** (4 * ((1354 + ((83285 * (2 ** (~10^32))) + (1280 * ((-16 + (2 ** (~10^32))) // 15)))) // 3)))) // 15))))",
    ),
