...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 0LD  1RC 0RF  1LC 1LA  0LE 1R_  1LF 0RB  0RC 0RE": (
        892,
        "((-11 + (3 ** ((13 + (3 ** ((21 + (3 ** ((7 + (3 ** ((23 + (3 ** ((7 + (3 ** ((23 + (3 ** ((7 + (3 ** ((21 + (3 ** ((7 + (3 ** ((23 + (3 ** ((7 + (3 ** 22146)) // 8))) // 8))) // 8))) // 8))) // 8))) // 8))) // 8))) // 8))) // 8))) // 8))) // 8))) // 2)",
    ),
    ...
    "1RB 3LA 4LB 0RB 1RA 3LA  2LA 2RA 4LA 1RA 5RB 1R_": (
        7796,
        "((463 + ((2 ** ((-37 + (61 * (2 ** ((-34 + ((2 ** ((-80 + (61 * (2 ** ((-55 + (61 * (2 ** (~10^32)))) // 9)))) // 9)) * (57 + (2 ** ((-62 + ((61 * (2 ** ((-55 + (61 * (2 ** (~10^32)))) // 9))) + -(-80 + (61 * (2 ** ((-55 + (61 * (2 ** (~10^32)))) // 9)))))) // 9))))) // 9)))) // 9)) * (45 + (2 ** ((-1 + ((61 * (2 ** ((-34 + ((2 ** ((-80 + (61 * (2 ** ((-55 + (61 * (2 ** (~10^32)))) // 9)))) // 9)) * (57 + (2 ** ((-62 + ((61 * (2 ** ((-55 + (61 * (2 ** (~10^32)))) // 9))) + -(-80 + (61 * (2 ** ((-55 + (61 * (2 ** (~10^32)))) // 9)))))) // 9))))) // 9))) + -(-37 + (61 * (2 ** ((-34 + ((2 ** ((-80 + (61 * (2 ** ((-55 + (61 * (2 ** (~10^32)))) // 9)))) // 9)) * (57 + (2 ** ((-62 + ((61 * (2 ** ((-55 + (61 * (2 ** (~10^32)))) // 9))) + -(-80 + (61 * (2 ** ((-55 + (61 * (2 ** (~10^32)))) // 9)))))) // 9))))) // 9)))))) // 9))))) // 3)",
    ),
    ...
    "1RB 1LA  1RC 0RE  1LD 0LA  1LC 0RD  1RC 1RB": (
        1461,
        "((-10 + ((2 ** ((-2 + ((2 ** ((-5 + ((2 ** ((-5 + (13 * (2 ** (~10^167)))) // 3)) * (3 + (5 * (2 ** ((-2 + ((13 * (2 ** (~10^167))) + -(-5 + (13 * (2 ** (~10^167)))))) // 3)))))) // 3)) * (3 + (5 * (2 ** ((-2 + (((2 ** ((-5 + (13 * (2 ** (~10^167)))) // 3)) * (3 + (5 * (2 ** ((-2 + ((13 * (2 ** (~10^167))) + -(-5 + (13 * (2 ** (~10^167)))))) // 3))))) + -(-5 + ((2 ** ((-5 + (13 * (2 ** (~10^167)))) // 3)) * (3 + (5 * (2 ** ((-2 + ((13 * (2 ** (~10^167))) + -(-5 + (13 * (2 ** (~10^167)))))) // 3)))))))) // 3)))))) // 3)) * (3 + (5 * (2 ** ((1 + (((2 ** ((-5 + ((2 ** ((-5 + (13 * (2 ** (~10^167)))) // 3)) * (3 + (5 * (2 ** ((-2 + ((13 * (2 ** (~10^167))) + -(-5 + (13 * (2 ** (~10^167)))))) // 3)))))) // 3)) * (3 + (5 * (2 ** ((-2 + (((2 ** ((-5 + (13 * (2 ** (~10^167)))) // 3)) * (3 + (5 * (2 ** ((-2 + ((13 * (2 ** (~10^167))) + -(-5 + (13 * (2 ** (~10^167)))))) // 3))))) + -(-5 + ((2 ** ((-5 + (13 * (2 ** (~10^167)))) // 3)) * (3 + (5 * (2 ** ((-2 + ((13 * (2 ** (~10^167))) + -(-5 + (13 * (2 ** (~10^167)))))) // 3)))))))) // 3))))) + -(-2 + ((2 ** ((-5 + ((2 ** ((-5 + (13 * (2 ** (~10^167)))) // 3)) * (3 + (5 * (2 ** ((-2 + ((13 * (2 ** (~10^167))) + -(-5 + (13 * (2 ** (~10^167)))))) // 3)))))) // 3)) * (3 + (5 * (2 ** ((-2 + (((2 ** ((-5 + (13 * (2 ** (~10^167)))) // 3)) * (3 + (5 * (2 ** ((-2 + ((13 * (2 ** (~10^167))) + -(-5 + (13 * (2 ** (~10^167)))))) // 3))))) + -(-5 + ((2 ** ((-5 + (13 * (2 ** (~10^167)))) // 3)) * (3 + (5 * (2 ** ((-2 + ((13 * (2 ** (~10^167))) + -(-5 + (13 * (2 ** (~10^167)))))) // 3)))))))) // 3)))))))) // 3)))))) // 3)",
    ),
