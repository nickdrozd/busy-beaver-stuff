...
ALGEBRA: dict[str, dict[str, tuple[int, str, str, str]]] = {
    "halt": {
        ...
        "1RB 0LA  1LC 1LF  0LD 0LC  0LE 0LB  1RE 0RA  1R_ 1LD": (
            ...
            "((8657965653 + (((7 * (2 ** ((-20 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))) + ((21 * (2 ** ((-38 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))) + ((105 * (2 ** ((-56 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))) + (((2 ** 69171) * (437 + (1309 * (2 ** ((-622613 + (19 * (2 ** 69175))) // 9))))) + (63 * (2 ** ((-65 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))))))) + (57 * (2 ** ((-35 + (7 * (2 ** ((-11 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9)))) // 9))))) // 27)",
        ),
        ...
        "1RB 1RE  1LC 1LF  1RD 0LB  1LE 0RC  1RA 0LD  1R_ 1LC": (
            ...
            "(((~10^18) + ((2205 * (2 ** ((-232 + (49 * (2 ** ((-34 + (49 * (2 ** ((62 + (49 * (2 ** 15172))) // 27)))) // 27)))) // 27))) + (((49 * (2 ** ((-88 + (49 * (2 ** ((62 + (49 * (2 ** 15172))) // 27)))) // 27))) + ((2205 * (2 ** ((-196 + (49 * (2 ** ((62 + (49 * (2 ** 15172))) // 27)))) // 27))) + (((2 ** 15160) * (200557 + (50029 * (2 ** ((-409528 + (49 * (2 ** 15172))) // 27))))) + (37485 * (2 ** ((-412 + (49 * (2 ** ((62 + (49 * (2 ** 15172))) // 27)))) // 27)))))) + (37485 * (2 ** ((-448 + (49 * (2 ** ((-34 + (49 * (2 ** ((62 + (49 * (2 ** 15172))) // 27)))) // 27)))) // 27)))))) // 81)",
        ),
    ...
    "count_apps: (2 ** ((-32 + (2 ** 37)) // 5)) % 100": {
        "1RB 2LA 5LB 0RA 1RA 3LB  1LA 4LA 3LB 3RB 3RB 1R_": (
            ...
            "((56002 + ((15 * (2 ** ((3 + (2 ** ((153 + (2 ** 37)) // 5))) // 5))) + ((2 ** ((158 + (2 ** 37)) // 5)) + ((2 ** ((158 + (2 ** 37)) // 5)) + ((2 ** ((158 + (2 ** 37)) // 5)) + ((15 * (2 ** ((-7 + (2 ** ((153 + (2 ** 37)) // 5))) // 5))) + ((2 ** ((158 + (2 ** 37)) // 5)) + ((2 ** ((148 + (2 ** 37)) // 5)) + ((2 ** 38) + ((15 * (2 ** ((148 + (2 ** 37)) // 5))) + ((2 ** 38) + ((2 ** 38) + ((2 ** 38) + ((5 * (2 ** 35)) * (5 + (3 * (2 ** ((-37 + (2 ** 37)) // 5)))))))))))))))))) // 5)",
        ),
    },
    ...
    "sub_exp": {
        ...
        "1RB 0LE  1RC 1RD  0LB ...  1LE 0RF  1RC 1LA  1LE 1RF": (
            ...
            "(10 ** 17)",
            "(463 + ((~10^15) * (2 ** 6)))",
            "(124668 + (((~10^15) * (2 ** 6)) + (((2 ** 5) * (2 + ((~10^13) * (2 ** 7)))) + (((~10^13) * (2 ** 7)) + (((2 ** 6) * (2 + (69265018113 * (2 ** 8)))) + ((69265018113 * (2 ** 8)) + (((2 ** 7) * (2 + (270566477 * (2 ** 9)))) + ((270566477 * (2 ** 9)) + (((2 ** 8) * (10 + (33820809 * (2 ** 4)))) + ((33820809 * (2 ** 5)) + ((304387281 * (2 ** 3)) + (((2 ** 2) * (2 + (4227601 * (2 ** 4)))) + ((4227601 * (2 ** 4)) + (((2 ** 3) * (2 + (264225 * (2 ** 5)))) + ((264225 * (2 ** 5)) + (((2 ** 4) * (2 + (8257 * (2 ** 6)))) + ((8257 * (2 ** 6)) + (((2 ** 6) * (268 + (2 ** 8))) + ((2 ** 5) * (2 + (129 * (2 ** 7))))))))))))))))))))))",
        ),
    },
    ...
    "sup_mul": {
        "1RB 0RC  1LC 1RA  0RC 1RD  1LE 0RB  1LB 0LD": (
            ...
            "(124519 + (((2 ** 14771) * (-9849 + ((~10^147) * (2 ** 2460)))) + (((2 ** 14770) * (-9849 + ((~10^147) * (2 ** 2460)))) + (((~10^147) * (2 ** 2459)) + (((2 ** 2458) * (-1641 + ((~10^24) * (2 ** 408)))) + (((~10^24) * (2 ** 407)) + (((2 ** 7) * ((~10^22) + (39 * (2 ** 66)))) + ((2 ** 406) * (-273 + (19923 * (2 ** 66)))))))))))",
        ),
    ...
    "infrul": {
        ...
        "1RB 1RA  0LB 1RC  0LD 0LC  1RA 1LE  0LC 1LD": (
            ...
            "(403 + ((((5 * (2 ** (-3 + (5 * (2 ** 17))))) + ((5 * (2 ** 18)) * (1 + (2 ** (-21 + (5 * (2 ** 17))))))) + (5 * (2 ** (-2 + (5 * (2 ** (-3 + (5 * (2 ** 17))))))))) + (5 * (2 ** (-2 + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** 17)))))))))))))",
        ),
        ...
        "1RB 0RD  0LC 1RE  1RA 1LD  0LC 1LC  0RD 0LE": (
            ...
            "(811 + (((3 * (2 ** (3 * (2 ** (-1 + (3 * (2 ** (-1 + (3 * (2 ** 11)))))))))) + (((3 * (2 ** (3 * (2 ** (-1 + (3 * (2 ** 11))))))) + (((2 ** 11) * (15 + (15 * (2 ** (-12 + (3 * (2 ** 11))))))) + (9 * (2 ** (-1 + (3 * (2 ** (-1 + (3 * (2 ** 11)))))))))) + (9 * (2 ** (-1 + (3 * (2 ** (-1 + (3 * (2 ** (-1 + (3 * (2 ** 11))))))))))))) + (9 * (2 ** (-1 + (3 * (2 ** (-1 + (3 * (2 ** (-1 + (3 * (2 ** (-1 + (3 * (2 ** 11))))))))))))))))",
        ),
        "1RB 1RA  0LC 1RE  0LE 1LD  0LB 1LC  1LA 0LE": (
            504,
            "(10 ↑↑ 6)",
            "((-1 + (7 * (2 ** ((8 + (7 * (2 ** ((8 + (7 * (2 ** ((8 + (7 * (2 ** ((8 + (7 * (2 ** 9560))) // 3)))) // 3)))) // 3)))) // 3)))) // 3)",
            "((64211 + ((((7 * (2 ** ((5 + (7 * (2 ** 9560))) // 3))) + ((7 * (2 ** 9560)) * (1 + (2 ** ((-28675 + (7 * (2 ** 9560))) // 3))))) + (7 * (2 ** ((8 + (7 * (2 ** ((8 + (7 * (2 ** 9560))) // 3)))) // 3)))) + (7 * (2 ** ((8 + (7 * (2 ** ((8 + (7 * (2 ** ((8 + (7 * (2 ** 9560))) // 3)))) // 3)))) // 3))))) // 3)",
        ),
        ...
        "1RB 0RD  0LC 1RE  1RA 1LD  0LC 1LC  0LD 0LE": (
            ...
            "(92 + (((5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** 17))))))))))) + (((5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** 17)))))))) + (((2 ** 18) * (15 + (15 * (2 ** (-20 + (5 * (2 ** 17))))))) + (25 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** 17)))))))))) + (25 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** 17))))))))))))) + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** 17))))))))))))))))",
        ),
        ...
        "1RB 1LA  1RC 0RE  1LD 0LA  1LC 0RD  1RC 1RB": (
            ...
            "(7724 + ((((39 * (2 ** 552)) * (1 + (2 ** ((-1664 + (13 * (2 ** 553))) // 3)))) + (39 * (2 ** ((-8 + (13 * (2 ** ((-5 + (13 * (2 ** 553))) // 3)))) // 3)))) + (39 * (2 ** ((-8 + (13 * (2 ** ((-5 + (13 * (2 ** ((-5 + (13 * (2 ** 553))) // 3)))) // 3)))) // 3)))))",
        ),
        ...
        "1RB 0LE  0RC 1RB  0RD 1RA  1LD 1LA  1LC 0RB": (
            ...
            "10",
            "10",
            "(1938 + ((5 * (2 ** (-5 + (5 * (2 ** (-5 + (5 * (2 ** (-5 + (5 * (2 ** 155))))))))))) + (((5 * (2 ** (-5 + (5 * (2 ** (-5 + (5 * (2 ** 155)))))))) + (((2 ** 154) * (55 + (55 * (2 ** (-160 + (5 * (2 ** 155))))))) + (45 * (2 ** (-6 + (5 * (2 ** (-5 + (5 * (2 ** 155)))))))))) + (45 * (2 ** (-6 + (5 * (2 ** (-5 + (5 * (2 ** (-5 + (5 * (2 ** 155))))))))))))))",
        ),
        "1RB 0LE  0RC 0LC  0RD 1RA  1LD 1LA  1LC 0RB": (
            1718,
            "10",
            "10",
            "(2476 + ((25 * (2 ** (-5 + (5 * (2 ** (-5 + (5 * (2 ** (-5 + (5 * (2 ** 155))))))))))) + (((25 * (2 ** (-5 + (5 * (2 ** (-5 + (5 * (2 ** 155)))))))) + (((2 ** 154) * (95 + (95 * (2 ** (-160 + (5 * (2 ** 155))))))) + (45 * (2 ** (-6 + (5 * (2 ** (-5 + (5 * (2 ** 155)))))))))) + (45 * (2 ** (-6 + (5 * (2 ** (-5 + (5 * (2 ** (-5 + (5 * (2 ** 155))))))))))))))",
        ),
        ...
        "1RB 0RA  1LC 0LB  0LE 0LD  1LB 0LC  1RE 1RA": (
            ...
            "3",
            "3",
            "((40637 + ((5 * (2 ** ((-11 + (5 * (2 ** ((-8 + (5 * (2 ** ((-8 + (5 * (2 ** 24))) // 3)))) // 3)))) // 3))) + (((5 * (2 ** ((-11 + (5 * (2 ** ((-8 + (5 * (2 ** 24))) // 3)))) // 3))) + (((2 ** 21) * (35 + (35 * (2 ** ((-80 + (5 * (2 ** 24))) // 3))))) + (15 * (2 ** ((-17 + (5 * (2 ** ((-8 + (5 * (2 ** 24))) // 3)))) // 3))))) + (15 * (2 ** ((-17 + (5 * (2 ** ((-8 + (5 * (2 ** ((-8 + (5 * (2 ** 24))) // 3)))) // 3)))) // 3)))))) // 3)",
        ),
