...
ALGEBRA_STRINGS: dict[str, tuple[int, str]] = {
    ...
    "1RB 0LA  1LC 1LF  0LD 0LC  0LE 0LB  1RE 0RA  1R_ 1LD": (
        3344,
        "(208787669 + ((26097891 * (2 ** (13171 + ((70837131 * (2 ** 69150)) + ((-118784 + (29 * (2 ** 69150))) // 9))))) + ((-40960 + (5 * (2 ** (13171 + ((70837131 * (2 ** 69150)) + ((-118784 + (29 * (2 ** 69150))) // 9)))))) // 9)))",
    ),
    ...
    "1RB 1LE  1RC 1RF  1LD 0RB  1RE 0LC  1LA 0RD  1R_ 1RC": (
        5723,
        "(2126281 + (((~10^15) * (2 ** 60630)) + ((-19136512 + (73 * (2 ** 60630))) // 9)))",
    ),
    "1RB 0LD  1RC 0RF  1LC 1LA  0LE 1R_  1LA 0RB  0RC 0RE": (
        413,
        "(107 + ((3 ** 22145) + ((-189 + (7 * (3 ** 22145))) // 2)))",
    ),
    ...
    "1RB 1RE  1LC 1LF  1RD 0LB  1LE 0RC  1RA 0LD  1R_ 1LC": (
        10105,
        "((~10^15) + ((79 * (2 ** (8 + ((408245484 + (((~10^17) * (2 ** 15120)) + ((-1224736768 + (73 * (2 ** 15120))) // 3))) // 9)))) + ((-76546048 + (73 * (2 ** (8 + ((408245484 + (((~10^17) * (2 ** 15120)) + ((-1224736768 + (73 * (2 ** 15120))) // 3))) // 9))))) // 9)))",
    ),
    ...
    "1RB 3LA 4LB 0RB 1RA 3LA  2LA 2RA 4LA 1RA 5RB 1R_": (
        5524,
        "(1524 + ((157 * (2 ** (4 + ((5416 + ((83285 * (2 ** (~10^32))) + ((-16384 + (2 ** (~10^32))) // 3))) // 3)))) + ((-4352 + (17 * (2 ** (4 + ((5416 + ((83285 * (2 ** (~10^32))) + ((-16384 + (2 ** (~10^32))) // 3))) // 3))))) // 3)))",
    ),
    ...
    "1RB 1LA  1RC 0RE  1LD 0LA  1LC 0RD  1RC 1RB": (
        1299,
        "(54 + ((2 ** (26 + ((2 ** (~10^167)) + ((-80 + (5 * (2 ** (~10^167)))) // 3)))) + ((-160 + (5 * (2 ** (27 + ((2 ** (~10^167)) + ((-80 + (5 * (2 ** (~10^167)))) // 3)))))) // 3)))",
    ),
    "1RB 0LD  0RC 1LD  1LA 1RE  0LA 0LB  1RC 0RA": (
        4846,
        "(3662110501 + (((-2187 + (3 ** 1464843751)) // 2) + ((1093 * (3 ** 1464843751)) + (((3 ** 1464843751) * ((-2187 + (3 ** 292968751)) // 2)) + ((1093 * (3 ** 1757812502)) + (((3 ** 1757812502) * ((-2187 + (3 ** 58593751)) // 2)) + ((1093 * (3 ** 1816406253)) + (((3 ** 1816406253) * ((-2187 + (3 ** 11718751)) // 2)) + ((1093 * (3 ** 1828125004)) + (((3 ** 1828125004) * ((-2187 + (3 ** 2343751)) // 2)) + ((1093 * (3 ** 1830468755)) + (((3 ** 1830468755) * ((-2187 + (3 ** 468751)) // 2)) + ((1093 * (3 ** 1830937506)) + (((3 ** 1830937506) * ((-2187 + (3 ** 93751)) // 2)) + ((1093 * (3 ** 1831031257)) + (((3 ** 1831031257) * ((-2187 + (3 ** 18751)) // 2)) + ((1093 * (3 ** 1831050008)) + (((~10^449) * (3 ** 1831053759)) + ((3 ** 1831050008) * ((-2187 + (3 ** 3751)) // 2))))))))))))))))))))",
    ),
    ...
    "1RB 0RE  1LC 1RE  1RD 0LB  1RA 0RD  1LC 0RA": (
        7704,
        "(46673952769 + (-(2 ** 23336976370) + (((2 ** 23336976369) * (-(2 ** 11668488187) * (1 + (2 ** 5834244094)))) + (((2 ** 40839708649) * (-(2 ** 2917122049) * (1 + (2 ** 1458561025)))) + (((2 ** 45215391722) * (-(2 ** 729280514) * (1 + (2 ** 364640257)))) + (((2 ** 46309312492) * (-(2 ** 182320131) * (1 + (2 ** 91160066)))) + (((2 ** 46582792688) * (-(2 ** 45580035) * (1 + (2 ** 22790018)))) + (((2 ** 46651162740) * (-(2 ** 11395011) * (1 + (2 ** 5697506)))) + (((2 ** 46668255256) * (-(2 ** 2848755) * (1 + (2 ** 1424378)))) + (((2 ** 46672528388) * (-(2 ** 712191) * (1 + (2 ** 356096)))) + (((2 ** 46673596674) * (-(2 ** 178050) * (1 + (2 ** 89025)))) + (((2 ** 46673863748) * (-(2 ** 44514) * (1 + (2 ** 22258)))) + (((2 ** 46673930519) * (-(2 ** 11131) * (1 + (2 ** 5566)))) + ((2 ** 46673950000) * (-1 + ((~10^425) * (2 ** 1393)))))))))))))))))",
    ),
}
