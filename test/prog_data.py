...
ALGEBRA: dict[str, dict[str, tuple[int, str, str, str]]] = {
    "halt": {
        ...
        "1RB 0LA  1LC 1LF  0LD 0LC  0LE 0LB  1RE 0RA  1R_ 1LD": (
            ...
            "((8657965653 + ((57 * (2 ** ((-44 + (7 * (2 ** ((-11 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9)))) // 9))) + ((57 * (2 ** ((-44 + (7 * (2 ** ((-11 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9)))) // 9))) + ((7 * (2 ** ((-20 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))) + ((21 * (2 ** ((-38 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))) + ((21 * (2 ** ((-38 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))) + ((21 * (2 ** ((-56 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))) + ((21 * (2 ** ((-56 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))) + ((21 * (2 ** ((-74 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))) + (((2 ** 69171) * (437 + (1309 * (2 ** ((-622613 + (19 * (2 ** 69175))) // 9))))) + (21 * (2 ** ((-74 + (7 * (2 ** ((-11 + (19 * (2 ** 69175))) // 9)))) // 9))))))))))))) // 27)",
        ),
    ...
    "sub_exp": {
        ...
        "1RB 0LE  1RC 1RD  0LB ...  1LE 0RF  1RC 1LA  1LE 1RF": (
            ...
            "(10 ** 17)",
            "(463 + ((~10^15) * (2 ** 6)))",
            "(124668 + (((~10^15) * (2 ** 6)) + (((2 ** 5) * (2 + ((~10^13) * (2 ** 7)))) + (((~10^13) * (2 ** 7)) + (((2 ** 6) * (2 + (69265018113 * (2 ** 8)))) + ((69265018113 * (2 ** 8)) + (((2 ** 7) * (2 + (270566477 * (2 ** 9)))) + ((270566477 * (2 ** 9)) + (((2 ** 8) * (10 + (33820809 * (2 ** 4)))) + ((33820809 * (2 ** 4)) + ((33820809 * (2 ** 4)) + ((33820809 * (2 ** 4)) + ((33820809 * (2 ** 4)) + ((33820809 * (2 ** 4)) + ((33820809 * (2 ** 4)) + ((33820809 * (2 ** 3)) + (((2 ** 2) * (2 + (4227601 * (2 ** 4)))) + ((4227601 * (2 ** 4)) + (((2 ** 3) * (2 + (264225 * (2 ** 5)))) + ((264225 * (2 ** 5)) + (((2 ** 4) * (2 + (8257 * (2 ** 6)))) + ((8257 * (2 ** 6)) + (((2 ** 6) * (268 + (2 ** 8))) + ((2 ** 5) * (2 + (129 * (2 ** 7)))))))))))))))))))))))))))",
        ),
    },
    ...
    "infrul": {
        ...
        "1RB 1RA  1LC 0RB  1LB 1LD  0RA 0RE  0RB 1RE": (
            ...
            "(106 + ((3 * (2 ** (-2 + (3 * (2 ** (-2 + (3 * (2 ** (-2 + (3 * (2 ** 46))))))))))) + (((3 * (2 ** (-2 + (3 * (2 ** (-2 + (3 * (2 ** 46)))))))) + (((2 ** 45) * (9 + (9 * (2 ** (-48 + (3 * (2 ** 46))))))) + (3 * (2 ** (-3 + (3 * (2 ** (-2 + (3 * (2 ** 46)))))))))) + (3 * (2 ** (-3 + (3 * (2 ** (-2 + (3 * (2 ** (-2 + (3 * (2 ** 46))))))))))))))",
        ),
        "1RB 1RA  0LB 1RC  0LD 0LC  1RA 1LE  0LC 1LD": (
            416,
            "(10 ↑↑ 6)",
            "(-5 + (5 * (2 ** (-2 + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** 17)))))))))))))))",
            "(403 + ((5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** 17))))))))))) + (((5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** 17)))))))) + (((5 * (2 ** (-3 + (5 * (2 ** 17))))) + ((5 * (2 ** 18)) * (1 + (2 ** (-21 + (5 * (2 ** 17))))))) + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** 17)))))))))) + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** (-3 + (5 * (2 ** 17))))))))))))))",
        ),
        ...
        "1RB ...  1LC 0RB  1LD 0RD  0RE 1LB  0RC 1RF  0RA 1RE": (
            ...
            "((1503037 + (((69 * (6 ** ((-4 + (69 * (6 ** ((-4 + (69 * (6 ** 13))) // 5)))) // 5))) + (((6 ** 14) * (23 + (23 * (6 ** ((-69 + (69 * (6 ** 13))) // 5))))) + (69 * (6 ** ((-4 + (69 * (6 ** ((-4 + (69 * (6 ** 13))) // 5)))) // 5))))) + (69 * (6 ** ((-4 + (69 * (6 ** ((-4 + (69 * (6 ** ((-4 + (69 * (6 ** 13))) // 5)))) // 5)))) // 5))))) // 5)",
        ),
        ...
        "1RB 1RA  0LC 1RE  0LE 1LD  0LB 1LC  1LA 0LE": (
            ...
            "((64211 + ((7 * (2 ** ((5 + (7 * (2 ** ((8 + (7 * (2 ** ((8 + (7 * (2 ** 9560))) // 3)))) // 3)))) // 3))) + (((7 * (2 ** ((5 + (7 * (2 ** ((8 + (7 * (2 ** 9560))) // 3)))) // 3))) + (((7 * (2 ** ((5 + (7 * (2 ** 9560))) // 3))) + ((7 * (2 ** 9560)) * (1 + (2 ** ((-28675 + (7 * (2 ** 9560))) // 3))))) + (7 * (2 ** ((5 + (7 * (2 ** ((8 + (7 * (2 ** 9560))) // 3)))) // 3))))) + (7 * (2 ** ((5 + (7 * (2 ** ((8 + (7 * (2 ** ((8 + (7 * (2 ** 9560))) // 3)))) // 3)))) // 3)))))) // 3)",
        ),
        "1RB 0LE  1RC 1RA  1RD 0LA  0LA 1LD  0RB 1LA": (
            669,
            "(10 ↑↑ 6)",
            "(-1 + (3 * (2 ** (-5 + (3 * (2 ** (-4 + (3 * (2 ** (-4 + (3 * (2 ** (-4 + (3 * (2 ** 764)))))))))))))))",
            "(1506 + ((3 * (2 ** (-4 + (3 * (2 ** (-4 + (3 * (2 ** (-4 + (3 * (2 ** 764))))))))))) + (((3 * (2 ** (-4 + (3 * (2 ** (-4 + (3 * (2 ** 764)))))))) + (((2 ** 763) * (9 + (9 * (2 ** (-768 + (3 * (2 ** 764))))))) + (3 * (2 ** (-5 + (3 * (2 ** (-4 + (3 * (2 ** 764)))))))))) + (3 * (2 ** (-5 + (3 * (2 ** (-4 + (3 * (2 ** (-4 + (3 * (2 ** 764))))))))))))))",
        ),
        ...
        "1RB 1LA  1RC 0RE  1LD 0LA  1LC 0RD  1RC 1RB": (
            ...
            "((23172 + ((13 * (2 ** ((-8 + (13 * (2 ** ((-5 + (13 * (2 ** ((-5 + (13 * (2 ** 553))) // 3)))) // 3)))) // 3))) + ((13 * (2 ** ((-2 + (13 * (2 ** ((-5 + (13 * (2 ** ((-5 + (13 * (2 ** 553))) // 3)))) // 3)))) // 3))) + ((13 * (2 ** ((-5 + (13 * (2 ** ((-5 + (13 * (2 ** ((-5 + (13 * (2 ** 553))) // 3)))) // 3)))) // 3))) + (((13 * (2 ** ((-8 + (13 * (2 ** ((-5 + (13 * (2 ** 553))) // 3)))) // 3))) + ((13 * (2 ** ((-2 + (13 * (2 ** ((-5 + (13 * (2 ** 553))) // 3)))) // 3))) + ((13 * (2 ** ((-5 + (13 * (2 ** ((-5 + (13 * (2 ** 553))) // 3)))) // 3))) + (((117 * (2 ** 552)) * (1 + (2 ** ((-1664 + (13 * (2 ** 553))) // 3)))) + (13 * (2 ** ((-5 + (13 * (2 ** ((-5 + (13 * (2 ** 553))) // 3)))) // 3))))))) + (13 * (2 ** ((-5 + (13 * (2 ** ((-5 + (13 * (2 ** ((-5 + (13 * (2 ** 553))) // 3)))) // 3)))) // 3)))))))) // 3)",
        ),
        ...
        "1RB 0RA  1LC 0LB  0LE 0LD  1LB 0LC  1RE 1RA": (
            ...
            "3",
            "3",
            "((40637 + ((5 * (2 ** ((-11 + (5 * (2 ** ((-8 + (5 * (2 ** ((-8 + (5 * (2 ** 24))) // 3)))) // 3)))) // 3))) + ((5 * (2 ** ((-14 + (5 * (2 ** ((-8 + (5 * (2 ** ((-8 + (5 * (2 ** 24))) // 3)))) // 3)))) // 3))) + (((5 * (2 ** ((-11 + (5 * (2 ** ((-8 + (5 * (2 ** 24))) // 3)))) // 3))) + ((5 * (2 ** ((-14 + (5 * (2 ** ((-8 + (5 * (2 ** 24))) // 3)))) // 3))) + (((2 ** 21) * (35 + (35 * (2 ** ((-80 + (5 * (2 ** 24))) // 3))))) + (5 * (2 ** ((-17 + (5 * (2 ** ((-8 + (5 * (2 ** 24))) // 3)))) // 3)))))) + (5 * (2 ** ((-17 + (5 * (2 ** ((-8 + (5 * (2 ** ((-8 + (5 * (2 ** 24))) // 3)))) // 3)))) // 3))))))) // 3)",
        ),
