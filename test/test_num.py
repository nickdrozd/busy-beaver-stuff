...
class TestNum(TestCase):
    ...
    def test_depth(self):
        ...
        self.assert_depth(-Exp(2, 3), 1)
        self.assert_depth(Exp(3, 3) + -Exp(2, 3), 2)
    ...
    def test_add_exp(self):
        ...
        self.assert_rep(
            ...
            "((3 ** (3 ** 5)) + ((3 ** ((3 ** 5) * (-243 + (3 ** (3 ** 5))))) + (3 ** (5 + ((3 ** 5) * (-243 + (3 ** (3 ** 5))))))))")
    ...
    def test_exp_div(self):
        self.assert_num(
            Exp(2, 13) // Exp(2, 10),  # type: ignore[operator]
            8,
            "(2 ** 3)")

        self.assert_num(
            (2 ** Exp(2, 7)) // Exp(2, 10),  # type: ignore[operator]
            332306998946228968225951765070086144,
            "(2 ** (-10 + (2 ** 7)))")

        self.assert_num(
            (2 ** Exp(2, 7)) // (2 ** Exp(2, 5)),  # type: ignore[operator]
