...
class TestNum(TestCase):
    ...
    def test_exp_mod_special_case(self):
        ...
        self.assert_mod(
            Exp(2, ((-2 + (13 * Exp(2, 3))) // 3)),
            12,
            4)

        self.assert_mod(
            Exp(2, ((-5 + (13 * Exp(2, 3))) // 3)),
            6,
            2)

        self.assert_mod(
            Exp(2, ((-55 + (61 * Exp(2, 8))) // 9)),
            54,
            2)

        self.assert_mod(
            Exp(2, ((-11 + (19 * Exp(2, 7))) // 9)),
            162,
            122)
    ...
    def test_comparisons(self):
        ...
        self.assertFalse(
            ((1 + Exp(2, 2)) * Exp(2, (-3 + (Exp(2, 655357) * (1 + Exp(2, 2))))))
        ...
        self.assertLess(
            (-2 + ((1 + Exp(2, 2)) * Exp(2, (-3 + ((1 + Exp(2, 2)) * Exp(2, (-3 + ((1 + Exp(2, 2)) * Exp(2, (-3 + (Exp(2, 655357) * (1 + Exp(2, 2))))))))))))),
            (-2 + ((1 + Exp(2, 2)) * Exp(2, (-3 + ((1 + Exp(2, 2)) * Exp(2, (-3 + ((1 + Exp(2, 2)) * Exp(2, (-3 + ((1 + Exp(2, 2)) * Exp(2, (-3 + (Exp(2, 655357) * (1 + Exp(2, 2)))))))))))))))))
        ...
        self.assertFalse(
            (3 * Exp(2, (5 + (Exp(2, 5) * (1 + Exp(2, Exp(2, 5)))))))
                < Exp(2, Exp(2, 5)))
    ...
    def test_mul_add_neg(self):
        ...
        self.assert_num(
            (-6 + ((1 + Exp(2, 2)) * Exp(2, Exp(2, 3)))) - (-6 + ((1 + Exp(2, 2)) * Exp(2, 5))),
            1120,
            "(((1 + (2 ** 2)) * (2 ** (2 ** 3))) + -((2 ** 5) * (1 + (2 ** 2))))")

        self.assert_rep(
            (-4 + (-(Exp(2, 11760) * (1 + Exp(2, 5879))) + (Exp(2, 20578) * (-1 + ((~10^440) * Exp(2, 1469)))))) * Exp(2, 23517),
            "((2 ** 23517) * (-4 + (-((2 ** 11760) * (1 + (2 ** 5879))) + ((2 ** 20578) * (-1 + (-435 * (2 ** 1469)))))))")
    ...
    def test_add_exp(self):
        self.assert_rep(
            Exp(2, (5 + (Exp(2, 7) * (1 + Exp(2, (5 + Exp(2, 7))))))) + Exp(2, (5 + Exp(2, 7))),
            "((2 ** (5 + (2 ** 7))) * (1 + (2 ** (2 ** (12 + (2 ** 7))))))")

        self.assert_rep(
            Exp(2, (3 * Exp(2, (5 + (Exp(2, 5) * (1 + Exp(2, Exp(2, 5)))))))) + (3 * Exp(2, (2172 + (Exp(2, 5) * (1 + Exp(2, Exp(2, 5))))))),
            "((3 * (2 ** (2172 + ((2 ** 5) * (1 + (2 ** (2 ** 5))))))) + (2 ** (3 * (2 ** (5 + ((2 ** 5) * (1 + (2 ** (2 ** 5)))))))))")

        self.assert_rep(
            ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + (5 * Exp(2, (~10^96))))))))))))))))))))))))))))))))) + ((-1 + -Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + (5 * Exp(2, 5)))))))))))))))))))))))))),
            "(((-1 + -(2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + (5 * (2 ** 5)))))))))))))))))))))))))) + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + (5 * (2 ** -107)))))))))))))))))))))))))))))))))")

        self.assert_rep(
            Exp(3, (-(Exp(3, 5) * (-1 + Exp(3, (-5 + Exp(3, 5))))) + (Exp(3, 5) * (-1 + Exp(3, (-5 + Exp(3, Exp(3, Exp(3, 5))))))))) + (Exp(3, ((Exp(3, 5) * (-1 + Exp(3, (-5 + Exp(3, Exp(3, 5)))))) + -(Exp(3, 5) * (-1 + Exp(3, (-5 + Exp(3, 5))))))) * (1 + (2 * Exp(3, (1 + ((-(Exp(3, 5) * (-1 + Exp(3, (-5 + Exp(3, 5))))) + (Exp(3, 5) * (-1 + Exp(3, (-5 + Exp(3, Exp(3, 5))))))) + ((Exp(3, 5) * (-1 + Exp(3, (-5 + Exp(3, 5))))) + -(Exp(3, 5) * (-1 + Exp(3, (-5 + Exp(3, Exp(3, 5))))))))))))),
            "((3 ** (-((3 ** 5) * (-1 + (3 ** (-5 + (3 ** 5))))) + ((3 ** 5) * (-1 + (3 ** (-5 + (3 ** (3 ** (3 ** 5))))))))) + ((3 ** (((3 ** 5) * (-1 + (3 ** (-5 + (3 ** (3 ** 5)))))) + -((3 ** 5) * (-1 + (3 ** (-5 + (3 ** 5))))))) * (1 + (2 * (3 ** (1 + ((((3 ** 5) * (-1 + (3 ** (-5 + (3 ** 5))))) + -((3 ** 5) * (-1 + (3 ** (-5 + (3 ** (3 ** 5))))))) + ((((3 ** 5) * (-1 + (3 ** (-5 + (3 ** (3 ** 5)))))) + -((3 ** 5) * (-1 + (3 ** (-5 + (3 ** 5)))))) + ((-((3 ** 5) * (-1 + (3 ** (-5 + (3 ** 5))))) + ((3 ** 5) * (-1 + (3 ** (-5 + (3 ** (3 ** 5))))))) + (((3 ** 5) * (-1 + (3 ** (-5 + (3 ** 5))))) + -((3 ** 5) * (-1 + (3 ** (-5 + (3 ** (3 ** 5))))))))))))))))")
