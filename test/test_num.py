...
class TestNum(TestCase):
    ...
    def test_comparisons(self):
        ...
        self.assertFalse(
            ((2 + Exp(2, 3)) * Exp(2, ((-5 + (5 * Exp(2, 11))) // 3)))
                < Exp(2, 3))
        ...
        self.assertLess(
            Exp(2, 33) * (1 + Exp(2, 2)),
            (1 + Exp(2, 2)) * Exp(2, (-3 + (Exp(2, 33) * (1 + Exp(2, 2))))))
        ...
        self.assertFalse(
            (-(Exp(2, 8) * (-1 + Exp(2, (-8 + Exp(2, 8))))) + (Exp(2, 8) * (-1 + Exp(2, (-8 + Exp(2, Exp(2, Exp(2, 8))))))))
                < ((Exp(2, 8) * (-1 + Exp(2, (-8 + Exp(2, Exp(2, 8)))))) + -(Exp(2, 8) * (-1 + Exp(2, (-8 + Exp(2, 8)))))))
    ...
    def test_add_exp(self):
        self.assert_num(
            (Exp(2, 3) * (1 + Exp(2, (5 + Exp(2, 3))))) - Exp(2, 3),
            65536,
            "(2 ** (8 + (2 ** 3)))")

        self.assert_num(
            Exp(2, (3 * Exp(2, 3))) + (3 * Exp(2, 10 + Exp(2, 3))),
            17563648,
            "((2 ** (3 * (2 ** 3))) + (3 * (2 ** (10 + (2 ** 3)))))")

        self.assert_num(
            (5 * Exp(2, ((1 + Exp(2, 3)) // 3))) + (-5 * Exp(2, Exp(2, ((-1 + Exp(2, 4)) // 3)))),
            -21474836440,
            "((5 * (2 ** ((1 + (2 ** 3)) // 3))) + (-5 * (2 ** (2 ** ((-1 + (2 ** 4)) // 3)))))")

        self.assert_rep(
            Exp(3, Exp(3, 5)) + (Exp(3, ((Exp(3, 5) * (-1 + Exp(3, Exp(3, 5)))) + -(Exp(3, 5) * (-1 + Exp(3, 5))))) * (1 + Exp(3, 5))),
