...
class TestNum(TestCase):
    ...
    def test_comparisons(self):
        ...
        self.assert_less_not_implemented(
            Exp(2, 14),
            Exp(2, 14) + ((-127 * (2 ** (271 + Exp(2, 14)))) + (-(2 ** (271 + Exp(2, 14))) * (-129 + (63 * (2 ** (254 + Exp(2, 14))))))),
            "(2 ** 14) < ((2 ** 14) + ((-127 * (2 ** (271 + (2 ** 14)))) + (-(2 ** (271 + (2 ** 14))) * (-129 + (63 * (2 ** (254 + (2 ** 14))))))))")
    ...
    def test_div_mul(self):
        ...
        self.assert_num(
            (3 ** ((5 + Exp(3, 11)) // 8)) + ((-21 + (7 * (3 ** ((5 + Exp(3, 11)) // 8)))) // 2),
            "(10 ** 10566)",
            "((-21 + (3 ** ((21 + (3 ** 11)) // 8))) // 2)")
    ...
    def test_add_exp(self):
        ...
        self.assert_num(
            ...
            "(10 ↑↑ 3)",
            "((3 ** (3 ** 5)) + (244 * (3 ** ((3 ** 10) * (-1 + (3 ** (-5 + (3 ** 5))))))))")

        self.assert_num(
            (-20 + (13 * (2 ** ((-5 + (13 * Exp(2, 553))) // 3)))) + ((Exp(2, 552) * (117 + (117 * (2 ** Exp(2, 553))))) + (117 * (2 ** ((-8 + (13 * Exp(2, 553))) // 3)))),
            "(10 ↑↑ 3)",
            "(-20 + ((13 * (2 ** ((-5 + (13 * (2 ** 553))) // 3))) + (((2 ** 552) * (117 + (117 * (2 ** (2 ** 553))))) + (117 * (2 ** ((-8 + (13 * (2 ** 553))) // 3))))))")
