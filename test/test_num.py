...
class TestNum(TestCase):
    ...
    def test_mul_add_neg(self):
        ...
        self.assert_rep(
            (-4 + (-(Exp(2, 11760) * (1 + Exp(2, 5879))) + (Exp(2, 20578) * (-1 + (11 * Exp(2, 1469)))))) * Exp(2, 23517),
            "((2 ** 23517) * (-4 + (-((2 ** 11760) * (1 + (2 ** 5879))) + ((2 ** 20578) * (-1 + (11 * (2 ** 1469)))))))")
    ...
    def test_add_exp(self):
        ...
        self.assert_rep(
            ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + (5 * Exp(2, 11)))))))))))))))))))))))))))))))) + ((-1 + -Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + ((1 + Exp(2, 2)) * Exp(2, (-4 + (5 * Exp(2, (-4 + (5 * Exp(2, 5)))))))))))))))))))))))))),
            "(((-1 + -(2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + (5 * (2 ** 5)))))))))))))))))))))))))) + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + ((1 + (2 ** 2)) * (2 ** (-4 + (5 * (2 ** (-4 + (5 * (2 ** 11)))))))))))))))))))))))))))))))))")
