...
class TestNum(TestCase):
    ...
    def test_comparisons(self):
        ...
        # pylint: disable = line-too-long
        self.assertGreater(
            ((Exp(2, 5) * (-1 + (2 ** (-5 + Exp(2, 5))))) + -(Exp(2, 5) * (-1 + (2 ** (-5 + (2 ** Exp(2, 5))))))) + (-(Exp(2, 5) * (-1 + (2 ** (-5 + Exp(2, 5))))) + (Exp(2, 5) * (-1 + (2 ** (-5 + (2 ** (2 ** (2 ** Exp(2, 5))))))))),
            (-(Exp(2, 5) * (-1 + (2 ** (-5 + Exp(2, 5))))) + (Exp(2, 5) * (-1 + (2 ** (-5 + (2 ** (2 ** Exp(2, 5)))))))) + ((Exp(2, 5) * (-1 + (2 ** (-5 + Exp(2, 5))))) + -(Exp(2, 5) * (-1 + (2 ** (-5 + (2 ** Exp(2, 5))))))))

        self.assertLess(
            -(Exp(2, 5) * (-1 + (2 ** (-13 + Exp(2, 5))))) + (Exp(2, 5) * (-1 + (2 ** (-13 + (2 ** (-7 + Exp(2, 5))))))),
            1 + (-(Exp(2, 5) * (-1 + (2 ** (-13 + Exp(2, 5))))) + (Exp(2, 5) * (-1 + (2 ** (-13 + (2 ** (-7 + Exp(2, 5)))))))))
    ...
    def test_div_gcd(self):
        ...
        # pylint: disable = line-too-long
        self.assert_num(
            (13164 + ((70837131 * Exp(2, 2)) + ((-118784 + (29 * Exp(2, 2))) // 9))) // 3,
            94449500,
            "((-308 + (19 * (2 ** 27))) // 27)")
