...
fn test_deciders() {
    ...
    assert_params![
        ...
        (2, 3) => [
            ...
            1 => (params_2_3_1, 20, (524, 3_510)),
            2 => (params_2_3_2, 20, (131, 5_962)),
        ],
        (4, 2) => [
            0 => (params_4_2_0, 25, (114_653, 432_318)),
            1 => (params_4_2_1, 99, (84_773, 754_707)),
            2 => (params_4_2_2, 99, (98_227, 1_933_882)),
        ],
        (2, 4) => [
            0 => (params_2_4_0, 109, (87_281, 309_759)),
            1 => (params_2_4_1, TREE_LIM, (87_383, 613_031)),
            2 => (params_2_4_2, TREE_LIM, (15_068, 1_190_832)),
        ],
    ];
}
...
fn test_quasihalt() {
    ...
    assert_params![
        (2, 2) => [
            3 => (quasihalt_2_2, 4, (32, 81)),
        ],
        (3, 2) => [
            3 => (quasihalt_3_2, 13, (10_158, 11_758)),
        ],
        (2, 3) => [
            3 => (quasihalt_2_3, 20, (4_585, 8_771)),
        ],
        (4, 2) => [
            3 => (quasihalt_4_2, 99, (2_099_250, 2_135_991)),
        ],
        (2, 4) => [
            3 => (quasihalt_2_4, TREE_LIM, (1_177_653, 1_699_887)),
        ],
    ];
}
