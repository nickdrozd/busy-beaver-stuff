...
fn test_deciders() {
    ...
    assert_params![
        ...
        (4, 2) => [
            ...
            1 => (params_4_2_1, 99, (85_433, 754_707)),
            2 => (params_4_2_2, 99, (98_258, 1_933_882)),
        ],
        (2, 4) => [
            0 => (params_2_4_0, 109, (87_281, 309_759)),
            1 => (params_2_4_1, TREE_LIM, (88_358, 613_031)),
            2 => (params_2_4_2, TREE_LIM, (16_220, 1_190_832)),
        ],
    ];
}
