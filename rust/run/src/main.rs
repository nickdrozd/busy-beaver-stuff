...
fn test_quasihalt() {
    ...
    assert_params![
        (2, 2) => [
            3 => (quasihalt_2_2, 4, (65, 81)),
        ],
        (3, 2) => [
            3 => (quasihalt_3_2, 13, (11_561, 11_758)),
        ],
        (2, 3) => [
            3 => (quasihalt_2_3, 20, (8_486, 8_771)),
        ],
        (4, 2) => [
            3 => (quasihalt_4_2, 99, (2_133_733, 2_135_991)),
        ],
        (2, 4) => [
            3 => (quasihalt_2_4, TREE_LIM, (1_696_221, 1_699_887)),
        ],
    ];
}
