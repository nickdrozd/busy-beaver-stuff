...
fn test_deciders() {
    ...
    assert_params![
        ...
        (2, 3) => [
            ...
            1 => (params_2_3_1, 20, (522, 3_510)),
            2 => (params_2_3_2, 20, (126, 5_962)),
        ],
        (4, 2) => [
            0 => (params_4_2_0, 25, (114_653, 432_318)),
            1 => (params_4_2_1, 99, (84_764, 754_707)),
            2 => (params_4_2_2, 99, (98_223, 1_933_882)),
        ],
        (2, 4) => [
            0 => (params_2_4_0, 109, (87_281, 309_759)),
            1 => (params_2_4_1, TREE_LIM, (87_040, 613_031)),
...
fn test_params_slow() {
    ...
    assert_params![
        ...
        (3, 3) => [
            0 => (params_3_3_0, 2_700, (19_205_547, 24_057_699)),
            1 => (params_3_3_1, 3_000, (23_726_560, 51_028_928)),
            2 => (params_3_3_2, 3_000, (42_616_368, 123_294_779)),
        ],
        (2, 5) => [
            0 => (params_2_5_0, TREE_LIM, (62_262_454, 69_999_829)),
            1 => (params_2_5_1, TREE_LIM, (122_015_705, 163_068_753)),
            2 => (params_2_5_2, TREE_LIM, (101_517_397, 367_061_568)),
        ],
    ];
}
