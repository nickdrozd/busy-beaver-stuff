...
fn test_deciders() {
    ...
    assert_params![
        ...
        (4, 2) => [
            ...
            1 => (params_4_2_1, 99, (83_475, 753_582)),
            2 => (params_4_2_2, 99, (95_742, 1_932_610)),
            3 => (params_4_2_3, 99, (106_765, 2_134_923)),
        ],
        (2, 4) => [
            0 => (params_2_4_0, 109, (86_505, 308_968)),
            1 => (params_2_4_1, TREE_LIM, (85_788, 612_077)),
            2 => (params_2_4_2, TREE_LIM, (13_880, 1_189_643)),
