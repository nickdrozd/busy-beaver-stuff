...
fn test_deciders() {
    ...
    assert_params![
        ...
        (2, 3) => [
            ...
            2 => (params_2_3_2, 20, (120, 5_962)),
        ],
        (4, 2) => [
            0 => (params_4_2_0, 25, (115_958, 432_318)),
            1 => (params_4_2_1, 99, (88_767, 754_707)),
            2 => (params_4_2_2, 99, (112_035, 1_933_882)),
        ],
        (2, 4) => [
            0 => (params_2_4_0, 109, (88_144, 309_759)),
            1 => (params_2_4_1, TREE_LIM, (95_691, 613_031)),
            2 => (params_2_4_2, TREE_LIM, (33_561, 1_190_832)),
        ],
    ];
}
